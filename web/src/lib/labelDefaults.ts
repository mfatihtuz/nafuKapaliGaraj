...
export const DEFAULT_LABEL_TYPES: LabelType[] = [
  ...
  { id: 'lt-a1', name: 'A1 · büyük çekmece',        w_mm: 50, h_mm: 30, cols: 4, rows: 9,  qty: 16 },
  { id: 'lt-a2', name: 'A2 · 3D küçük çekmece',     w_mm: 38, h_mm: 21, cols: 5, rows: 13, qty: 40 },
  { id: 'lt-b1', name: 'B1 · dar hazne',            w_mm: 40, h_mm: 15, cols: 5, rows: 18, qty: 40 },
  { id: 'lt-c1', name: 'C1 · kule çekmecesi',       w_mm: 50, h_mm: 30, cols: 4, rows: 9,  qty: 9  },
]
